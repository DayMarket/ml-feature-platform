...
flowchart LR
    ...
    d6["silver.order_city_id.order_completion_city_features<br/>UTC 03:00 · P3 · airflow-python"]
    d7["silver.order_region_id.order_completion_region_features<br/>UTC 03:00 · P3 · airflow-python"]
    ...
    x3 -->|"sensor Δ1h"| d0
    x4 -->|"sensor Δ1h"| d0
    class d1,d2,d3,d4,d5,d6,d7 silver
    class d0 gold
...
gantt
    ...
    03h00 · 2 DAG · airflow-python×2 :milestone, s0_0180, 03:00, 0m
```
...
flowchart LR
    ...
    d7["silver.product_id.product_search_queries<br/>UTC 03:00 · P4 · large"]
    d8["silver.query_sku_group_id.search_query_sku_group_es_features<br/>manual · P3 · airflow-python"]
    d9["silver.sku_group_id.sku_group_orders<br/>UTC 01:00 · P3 · large"]
...
gantt
    ...
    03h00 · 3 DAG · large×2 · airflow-python×1 :milestone, s2_0180, 03:00, 0m
