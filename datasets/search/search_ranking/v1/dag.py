...
@dag(
    ...
    dag_id="feature-platform.datasets.search.search_ranking.v1",
)
def collect_search_ranking_dataset_v1():
    SparkKubernetesOperator(
        execution_timeout=timedelta(hours=10),
        task_id="getting_search_ranking_dataset",
        namespace="svc-data-spark-jobs",
        application_file=get_deployment(
            ".",
            "fetch_dataset_search_ranking_v1.yaml",
        ),
        kubernetes_conn_id="spark_k8s",
    )


dag = collect_search_ranking_dataset_v1()
