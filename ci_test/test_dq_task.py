...
def test_failure_callback_can_be_temporarily_disabled(monkeypatch) -> None:
    ...
    _fake_module(monkeypatch, "airflow.sdk", get_current_context=lambda: {}, task=decorator)
    _fake_module(
        monkeypatch,
    ...
    build_dq_task(
        "layers/gold/account_id_product_id/account_product_features/v1/config.yaml",
        ".",
