"""Опубликовать витрину релевантности категории запросу в ranking-service целиком."""
...
from config.factory import get_config, get_dag_settings, get_deployment, get_upload_components
...
def upload_query_category_relevance():
    for component in get_upload_components():
        with TaskGroup(
            ...
            upload_features = SparkKubernetesOperator(
                ...
                task_id=f"upload_query_category_relevance__{component['id']}",
...
dag = upload_query_category_relevance()
