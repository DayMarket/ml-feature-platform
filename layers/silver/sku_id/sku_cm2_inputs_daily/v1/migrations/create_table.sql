CREATE TABLE IF NOT EXISTS {target_table} (
    ...
    sku_id BIGINT COMMENT 'Положительный идентификатор SKU в диапазоне 1..2147483647; часть уникального ключа dt, sku_id',
    product_id INT COMMENT 'Положительный идентификатор товара в диапазоне 1..2147483647, по которому Main CM2 и PDP CM2 агрегируют SKU-значения в Gold',
