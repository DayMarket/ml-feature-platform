...
- `l6_category_id` — конечная `category_id` товара, кроме технического root `1`, который приводится к `NULL`;
...
- L6 — исходная конечная `product.category_id`, кроме технического root `1`.
