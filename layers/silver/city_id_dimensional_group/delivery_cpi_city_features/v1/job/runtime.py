"""Entity-local Airflow/Python runtime for the city delivery CPI snapshot."""
...
def parse_partition_date(value: str) -> date:
    """Дата партиции равна дате конца интервала: окно закрыто строго до неё."""
    return parse_interval_timestamp(value).date()
