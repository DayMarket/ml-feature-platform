"""Materialize the geo_user_activity_features silver Iceberg table from ClickHouse."""
...
def geo_user_activity_features_dag() -> None:
    @task()
    def materialize(partition_value: str) -> None:
        runtime = _load_module("runtime.py", "geo_user_activity_features_runtime")
        query = _load_module("query.py", "geo_user_activity_features_query")
...
dag = geo_user_activity_features_dag()
