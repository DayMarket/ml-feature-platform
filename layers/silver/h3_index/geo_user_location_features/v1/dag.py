"""Materialize the geo_user_location_features silver Iceberg table from ClickHouse."""
...
@dag(
    ...
    max_active_runs=1,
    tags=["feature-platform", CONFIG["dag"]["group_tag"], "operations", "silver", "h3", "geo", "user-location"],
...
dag = geo_user_location_features_dag()
