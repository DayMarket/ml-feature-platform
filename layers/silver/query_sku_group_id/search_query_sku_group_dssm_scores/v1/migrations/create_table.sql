CREATE TABLE IF NOT EXISTS {target_table} (
    date DATE COMMENT 'UTC-дата дневного окна ranking analytics, соответствует data_interval_start',
...
USING iceberg
COMMENT 'Silver: дневные DSSM scores на уровне query и sku_group_id из ranking analytics logs'
PARTITIONED BY (date)
