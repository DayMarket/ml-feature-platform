"""Trino query for region-level order completion and no-show shares."""
...
WITH region_stats AS (
    SELECT
        CAST(order_region_id AS BIGINT) AS order_region_id,
    ...
    WHERE analyze_date = {analyze_date_sql}
      ...
      AND order_region_id IS NOT NULL
    GROUP BY order_region_id
)
SELECT
