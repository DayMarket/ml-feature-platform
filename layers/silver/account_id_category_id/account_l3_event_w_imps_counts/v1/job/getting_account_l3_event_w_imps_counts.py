...
def build_account_l3_event_w_imps_counts(
    spark: SparkSession,
    run_date: str,
) -> DataFrame:
    return spark.sql(
...
def save_account_l3_event_w_imps_counts(
    spark: SparkSession,
    run_date: str,
    target_table: str,
) -> None:
    features = build_account_l3_event_w_imps_counts(
        spark,
        run_date,
    )
...
def run(spark: SparkSession, arguments: Arguments):
    save_account_l3_event_w_imps_counts(
        spark,
