...
# см. job/getting_product_search_queries.py, читает partition_end, не partition_start.
...
def collect_silver_product_search_queries():
    collect_features = SparkKubernetesOperator(
        ...
        task_id="getting_product_search_queries",
        namespace="svc-data-spark-jobs",
        application_file=get_deployment(
            ".",
            "fetch_silver_product_search_queries.yaml",
        ),
...
dag = collect_silver_product_search_queries()
