...
def collect_silver_account_l2_impression_counts_12h():
    SparkKubernetesOperator(
        execution_timeout=timedelta(hours=10),
        task_id="getting_account_l2_impression_counts_12h",
...
dag = collect_silver_account_l2_impression_counts_12h()
