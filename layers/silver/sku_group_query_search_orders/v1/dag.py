...
@dag(
    ...
    max_active_runs=1,
    tags=["spark", "feature-platform", dag_settings["team_tag"], "silver", "orders"],
...
def collect_silver_sku_group_query_search_orders():
    SparkKubernetesOperator(
        ...
        task_id="getting_sku_group_query_search_orders",
        namespace="svc-data-spark-jobs",
        application_file=get_deployment(
            ".",
            "fetch_silver_sku_group_query_search_orders.yaml",
        ),
        kubernetes_conn_id="spark_k8s",
    )


dag = collect_silver_sku_group_query_search_orders()
