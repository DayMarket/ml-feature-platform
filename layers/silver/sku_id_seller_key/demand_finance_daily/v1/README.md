...
После преобразования source-блок дополнительно делится по `max_batch_bytes`: число
строк ClickHouse само по себе не гарантирует размер широкой Arrow-порции.
