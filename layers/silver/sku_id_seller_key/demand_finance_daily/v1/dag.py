"""Дневные финансовые события SKU × продавец: ClickHouse → Iceberg, окно пересчёта или ручной диапазон."""
...
def finance_dag():
    ...
    def write(start: str, end: str) -> list[str]:
        from layers.silver.sku_id_seller_key.demand_finance_daily.v1.job.runtime import load_range
