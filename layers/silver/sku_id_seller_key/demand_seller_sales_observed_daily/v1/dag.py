"""Дневные продажи SKU × продавец: ClickHouse → Iceberg, окно пересчёта или ручной диапазон."""
...
def seller_sales_dag():
    ...
    def write(start: str, end: str) -> list[str]:
        from layers.silver.sku_id_seller_key.demand_seller_sales_observed_daily.v1.job.runtime import load_range
