"""Materialize account-product Gold features twice a day."""
...
def collect_gold_account_product_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_account_product_features",
...
dag = collect_gold_account_product_features()
