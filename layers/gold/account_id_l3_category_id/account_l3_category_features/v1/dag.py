"""Materialize account-L3-category Gold features twice a day."""
...
def collect_gold_account_l3_category_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_account_l3_category_features",
...
dag = collect_gold_account_l3_category_features()
