CREATE TABLE IF NOT EXISTS {target_table} (
    ...
    product_rating DOUBLE COMMENT 'Средний рейтинг sku group по опубликованным отзывам за все время на дату расчета',
...
USING iceberg
COMMENT 'Gold-фичи опубликованных отзывов и рейтинга товара на уровне sku_group_id за все время на дату расчета'
PARTITIONED BY (date)
