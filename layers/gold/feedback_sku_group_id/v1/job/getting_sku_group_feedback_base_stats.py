...
def build_sku_group_feedback_base_stats(
    spark: SparkSession,
    partition_date: str,
):
    return spark.sql(
...
def save_sku_group_feedback_base_stats(
    spark: SparkSession,
    partition_date: str,
    target_table: str,
) -> None:
    features = build_sku_group_feedback_base_stats(spark, partition_date)
...
def run(spark: SparkSession, arguments: Arguments):
    save_sku_group_feedback_base_stats(
        spark,
