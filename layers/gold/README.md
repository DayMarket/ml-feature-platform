...
- [`category_id_query_text`](category_id_query_text/README.md) — релевантность категории-кандидата поисковому запросу;
...
- [`account_id_brand_id`](account_id_brand_id/README.md) — recsys-признаки взаимодействия пользователя с брендом.
