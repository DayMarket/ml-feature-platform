"""Project the category level of the buyout item signal into the online category table after its DQ DAG."""
...
def buyout_online_category_features_dag() -> None:
    ...
    def materialize(interval_end_value: str) -> None:
        runtime = _load_module("runtime.py", "buyout_online_category_features_runtime")
        query = _load_module("query.py", "buyout_online_category_features_query")
...
dag = buyout_online_category_features_dag()
