CREATE TABLE IF NOT EXISTS {target_table} (
    ...
    CATEGORY__n_unique_female_clickers_28d INT COMMENT 'Количество уникальных female-пользователей листовой категории за 28 дней',
    CATEGORY__n_unique_male_clickers_28d INT COMMENT 'Количество уникальных male-пользователей листовой категории за 28 дней',
    CATEGORY__n_unique_clickers_with_age_28d INT COMMENT 'Количество уникальных пользователей листовой категории с возрастом от 13 до 100 лет за 28 дней',
    CATEGORY__known_age_clicker_share_28d DOUBLE COMMENT 'Доля уникальных пользователей категории с возрастом от 13 до 100 лет',
