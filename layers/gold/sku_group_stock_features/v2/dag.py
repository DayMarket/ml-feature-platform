...
@dag(
    ...
    dag_id="feature_platform_sku_group_stock_features_v2_gold_dag",
)
def collect_gold_sku_group_stock_features_v2():
    ...
    collect_features = SparkKubernetesOperator(
        ...
        application_file=get_deployment(
            ".",
            "fetch_gold_sku_group_stock_features_v2.yaml",
        ),
...
dag = collect_gold_sku_group_stock_features_v2()
