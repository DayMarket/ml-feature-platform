CREATE TABLE IF NOT EXISTS {target_table} (
    ...
    relevance INT COMMENT 'Метка релевантности 0/1/2 из gold.feature_platform_query_category_relevance: строка с самой свежей date не позже даты прогона, при равной date — максимальная метка; NULL при выгрузке отправляется как 0.0'
)
USING iceberg
