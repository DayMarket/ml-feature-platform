"""Materialize the buyout item signal snapshot from Trino to Iceberg."""
...
def buyout_item_signal_features_dag() -> None:
    @task(executor_config=_executor_config())
    def materialize(interval_end_value: str) -> None:
        runtime = _load_module("runtime.py", "buyout_item_signal_features_runtime")
        query = _load_module("query.py", "buyout_item_signal_features_query")
...
dag = buyout_item_signal_features_dag()
