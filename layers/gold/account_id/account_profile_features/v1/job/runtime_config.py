...
class SourceSettings:
    ...
    def table_names(self) -> tuple[str, ...]:
        return (
            ...
            self.sku_table,
            self.category_demographic_features_table,
...
def load_source_settings(config_path: Path | None = None) -> SourceSettings:
    ...
    return SourceSettings(
        ...
        category_demographic_features_table=_required_string(
            source,
            "category_demographic_features_table",
        ),
        product_base_features_table=_required_string(
            source,
            "product_base_features_table",
        ),
        product_ranking_features_table=_required_string(
            source,
            "product_ranking_features_table",
        ),
