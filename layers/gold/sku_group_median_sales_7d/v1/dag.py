...
@dag(
    ...
    dag_id="feature_platform_sku_group_median_sales_7d_gold_dag",
)
def collect_gold_sku_group_median_sales_7d():
    SparkKubernetesOperator(
        execution_timeout=timedelta(hours=2),
        task_id="getting_sku_group_median_sales_7d",
        namespace="svc-data-spark-jobs",
        application_file=get_deployment(
            ".",
            "fetch_gold_sku_group_median_sales_7d.yaml",
        ),
        kubernetes_conn_id="spark_k8s",
    )


dag = collect_gold_sku_group_median_sales_7d()
