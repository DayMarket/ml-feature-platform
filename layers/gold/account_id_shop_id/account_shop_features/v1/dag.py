"""Materialize account-shop Gold features twice a day."""
...
def _product_metadata_logical_date(logical_date):
    ...
    raise ValueError("account-shop schedule expects a 07:00 or 19:00 UTC logical date")
...
def collect_gold_account_shop_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_account_shop_features",
...
dag = collect_gold_account_shop_features()
