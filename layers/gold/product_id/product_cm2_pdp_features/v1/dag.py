"""Materialize PDP CM2 product features twice a day."""
...
def collect_gold_product_cm2_pdp_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_product_cm2_pdp_features",
...
dag = collect_gold_product_cm2_pdp_features()
