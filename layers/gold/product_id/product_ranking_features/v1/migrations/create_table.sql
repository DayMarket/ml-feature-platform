CREATE TABLE IF NOT EXISTS {target_table} (
    ...
    PRODUCT_STATS__category_return_rate_7d DOUBLE COMMENT 'Взвешенная доля возвращённых единиц листовой категории за 7 дней',
    PRODUCT_STATS__return_rate_smoothed_7d DOUBLE COMMENT 'Product return rate за 7 дней, сглаженный к baseline листовой категории с alpha 10',
    PRODUCT_STATS__return_rate_to_category_return_rate_7d DOUBLE COMMENT 'Product return rate к return rate листовой категории за 7 дней',
    PRODUCT_STATS__return_rate_smoothed_to_category_return_rate_7d DOUBLE COMMENT 'Smoothed product return rate к return rate листовой категории за 7 дней',
