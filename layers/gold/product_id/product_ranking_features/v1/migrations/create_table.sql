CREATE TABLE IF NOT EXISTS {target_table} (
    ...
    PRODUCT_STATS__feedback_lte_3_to_orders_rate_smoothed DOUBLE COMMENT 'Feedback rating 1..3 за 28 дней к orders_28d, сглаженное global prior с alpha 10',
    ...
    PRODUCT_STATS__category_return_rate_neg_3d DOUBLE COMMENT 'Взвешенная отрицательная доля строк RETURNED в листовой категории за 3 дня',
    PRODUCT_STATS__return_rate_neg_smoothed_3d DOUBLE COMMENT 'Отрицательная product return rate, сглаженная к baseline листовой категории за 3 дня с alpha 10',
    PRODUCT_STATS__return_rate_neg_to_category_return_rate_neg_3d DOUBLE COMMENT 'Отношение отрицательной product return rate к отрицательному baseline листовой категории за 3 дня',
    PRODUCT_STATS__return_rate_neg_smoothed_to_category_return_rate_neg_3d DOUBLE COMMENT 'Отношение сглаженной отрицательной product return rate к отрицательному baseline листовой категории за 3 дня',
    PRODUCT_STATS__category_return_rate_neg_28d DOUBLE COMMENT 'Взвешенная отрицательная доля строк RETURNED в листовой категории за 28 дней',
    PRODUCT_STATS__return_rate_neg_smoothed_28d DOUBLE COMMENT 'Отрицательная product return rate, сглаженная к baseline листовой категории за 28 дней с alpha 10',
    PRODUCT_STATS__return_rate_neg_to_category_return_rate_neg_28d DOUBLE COMMENT 'Отношение отрицательной product return rate к отрицательному baseline листовой категории за 28 дней',
    PRODUCT_STATS__return_rate_neg_smoothed_to_category_return_rate_neg_28d DOUBLE COMMENT 'Отношение сглаженной отрицательной product return rate к отрицательному baseline листовой категории за 28 дней'
)
USING iceberg
