"""Materialize product-ranking Gold features twice a day."""
...
PRODUCT_BASE_DAG_ID = "feature-platform.layers.gold.product_id.product_base_features"
...
def _daily_snapshot_logical_date(logical_date):
    ...
    raise ValueError(
        "product-ranking schedule expects a 07:00 or 19:00 UTC logical date"
    )
...
def collect_gold_product_ranking_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_product_ranking_features",
    ...
    (
        [wait_for_product_metadata_dq, wait_for_product_base_dq]
        >> materialize_task
        >> [dq_task, stats_task]
    )


dag = collect_gold_product_ranking_features()
