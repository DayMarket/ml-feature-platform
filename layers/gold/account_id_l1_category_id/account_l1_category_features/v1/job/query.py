...
SELECT
    ...
    CASE WHEN account.click_3d > 0 THEN account_conv_imp2click_3d / account.click_3d END AS conv_imp2click_div_total_account_conv_3d,
    CASE WHEN account.click_7d > 0 THEN account_conv_imp2click_7d / account.click_7d END AS conv_imp2click_div_total_account_conv_7d,
    CASE WHEN account.click_14d > 0 THEN account_conv_imp2click_14d / account.click_14d END AS conv_imp2click_div_total_account_conv_14d,
    CASE WHEN account.click_28d > 0 THEN account_conv_imp2click_28d / account.click_28d END AS conv_imp2click_div_total_account_conv_28d,
    CASE WHEN account.atc_3d > 0 THEN account_conv_imp2atc_3d / account.atc_3d END AS conv_imp2atc_div_total_account_conv_3d,
    CASE WHEN account.atc_7d > 0 THEN account_conv_imp2atc_7d / account.atc_7d END AS conv_imp2atc_div_total_account_conv_7d,
    CASE WHEN account.atc_14d > 0 THEN account_conv_imp2atc_14d / account.atc_14d END AS conv_imp2atc_div_total_account_conv_14d,
    CASE WHEN account.atc_28d > 0 THEN account_conv_imp2atc_28d / account.atc_28d END AS conv_imp2atc_div_total_account_conv_28d,
    CASE WHEN account.atf_3d > 0 THEN account_conv_imp2atf_3d / account.atf_3d END AS conv_imp2atf_div_total_account_conv_3d,
    CASE WHEN account.atf_7d > 0 THEN account_conv_imp2atf_7d / account.atf_7d END AS conv_imp2atf_div_total_account_conv_7d,
    CASE WHEN account.atf_14d > 0 THEN account_conv_imp2atf_14d / account.atf_14d END AS conv_imp2atf_div_total_account_conv_14d,
    CASE WHEN account.atf_28d > 0 THEN account_conv_imp2atf_28d / account.atf_28d END AS conv_imp2atf_div_total_account_conv_28d,
    CASE WHEN account.order_3d > 0 THEN account_conv_imp2order_3d / account.order_3d END AS conv_imp2order_div_total_account_conv_3d,
    CASE WHEN account.order_7d > 0 THEN account_conv_imp2order_7d / account.order_7d END AS conv_imp2order_div_total_account_conv_7d,
    CASE WHEN account.order_14d > 0 THEN account_conv_imp2order_14d / account.order_14d END AS conv_imp2order_div_total_account_conv_14d,
    CASE WHEN account.order_28d > 0 THEN account_conv_imp2order_28d / account.order_28d END AS conv_imp2order_div_total_account_conv_28d
FROM features
