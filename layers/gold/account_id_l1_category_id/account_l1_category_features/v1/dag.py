"""Materialize account-L1-category Gold features twice a day."""
...
def collect_gold_account_l1_category_features():
    ...
    wait_for_impression_counts_dq = ExternalTaskSensor(
        task_id="wait_for_silver_account_l1_impression_counts_dq",
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_account_l1_category_features",
