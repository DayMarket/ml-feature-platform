...
@dag(
    ...
    dag_id="feature_platform_category_ad_rating_features_gold_dag",
)
def collect_gold_category_ad_rating_features():
    ...
    collect_features = SparkKubernetesOperator(
        ...
        task_id="getting_category_ad_rating_features",
        namespace="svc-data-spark-jobs",
        application_file=get_deployment(
            ".",
            "fetch_gold_category_ad_rating_features.yaml",
        ),
...
dag = collect_gold_category_ad_rating_features()
