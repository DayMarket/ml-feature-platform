...
DAG id: `feature-platform.layers.gold.sku_group_id.sku_group_ad_revenue_features`.
...
`/git/repo/layers/gold/sku_group_id/sku_group_ad_revenue_features/v1/entrypoints/get_sku_group_ad_revenue_features.py`,
