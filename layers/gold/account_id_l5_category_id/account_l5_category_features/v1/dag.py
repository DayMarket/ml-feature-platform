"""Materialize account-L5-category Gold features twice a day."""
...
def collect_gold_account_l5_category_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_account_l5_category_features",
    ...
    [wait_for_product_metadata_dq, wait_for_action_counts_dq] >> materialize_task >> [dq_task, stats_task]


dag = collect_gold_account_l5_category_features()
