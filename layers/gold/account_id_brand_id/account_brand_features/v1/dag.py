"""Materialize account-brand Gold features twice a day."""
...
def _product_metadata_logical_date(logical_date):
    ...
    raise ValueError("account-brand schedule expects a 07:00 or 19:00 UTC logical date")
...
# Раскомментировать после завершения отладки нового recsys Gold DAG.
...
def collect_gold_account_brand_features():
    ...
    materialize_task = SparkKubernetesOperator(
        ...
        task_id="getting_account_brand_features",
