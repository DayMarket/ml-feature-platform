...
`feature-platform.layers.gold.query_sku_group_id.query_skg_pairwise_features_legacy`:
...
@dag(
    ...
    dag_id="feature-platform.layers.gold.query_sku_group_id.query_skg_pairwise_features_legacy.backfill",
)
