...
@dag(
    ...
    max_active_runs=1,
    tags=["spark", "feature-platform", dag_settings["team_tag"], "gold", "orders", "atc", "query-id"],
    is_paused_upon_creation=True,
    schedule=CronDataIntervalTimetable("0 6 * * *", "UTC"),
    start_date=datetime(2026, 8, 11, 0, 0, 0, tzinfo=timezone.utc),
    dag_id="feature-platform.layers.gold.query_sku_group_id.sku_group_query_atc_order_features_qid",
)
def collect_gold_sku_group_query_atc_order_features_qid():
    ...
    wait_for_silver_install_stats = ExternalTaskSensor(
        ...
        external_dag_id="feature-platform.layers.silver.sku_group_id_query_category.sku_group_install",
        external_task_id="dq",
        allowed_states=["success"],
        failed_states=["failed"],
        mode="poke",
    ...
    wait_for_silver_search_orders = ExternalTaskSensor(
        ...
        external_dag_id="feature-platform.layers.silver.query_sku_group_id.sku_group_query_search_orders",
        external_task_id="dq",
        allowed_states=["success"],
        failed_states=["failed"],
        mode="poke",
    ...
    collect_features = SparkKubernetesOperator(
        ...
        task_id="getting_sku_group_query_atc_order_features_qid",
        namespace="svc-data-spark-jobs",
        application_file=get_deployment(
            ".",
            "fetch_gold_sku_group_query_atc_order_features_qid.yaml",
        ),
